 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Debug| F11  | F12  |Aud on|Audoff|AGnorm|AGswap|      |      |      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
      ...
      DEBUG,  KC_F11,  KC_F12,   AU_ON,  AU_OFF, AG_NORM, AG_SWAP, _______, _______, _______,  _______,  _______,
     MU_MOD,  MUV_DE,  MUV_IN,   MU_ON,  MU_OFF,   MI_ON,  MI_OFF, TERM_ON,TERM_OFF, _______,  _______,  _______,
  ...
  float tone_zelda0[][2]    = SONG(ZELDA_PUZZLE);
  float tone_zelda1[][2]    = SONG(ZELDA_TREASURE);
  float tone_mushroom[][2] = SONG(MARIO_MUSHROOM);
#endif
